<template>
  <div class="car-list-container pt-5">
    ...
    <section class="card-filter mt-4 mb-4 d-flex px-4 py-4">
       ...
       <section class="parts">
        <!-- item  -->
        <button class="item d-flex btn" @click="filterCars('Total Cars')">
         ...
         <!-- item  -->
        <button class="item d-flex btn" @click="filterCars('New Cars')">
         ...
         <!-- item  -->
        <button class="item d-flex btn" @click="filterCars('Towing')">
         ...
         <!-- item  -->
        <button class="item d-flex btn" @click="filterCars('WareHouses')">
         ...
         <!-- item  -->
        <button class="item d-flex btn" @click="filterCars('Shipping')">
          ...
          <!-- item  -->
        <button class="item d-flex btn"  @click="filterCars('Port')">
          ...
          <!-- item  -->
        <button class="item d-flex btn" @click="filterCars('Arrived')">
          ...
          <!-- item  -->
        <button class="item d-flex btn" @click="filterCars('Received')">
   ...
   <h3 class="cat-title fw-bold my-cars-title mt-4 mb-4 text-start" v-if="type!==''">{{ type }} (3)</h3>

    <div class="car-list" v-if="type!==''">
  ...
  <g clip-path="url(#clip0_353_3275)">
    ...
    <path d="M54.5109 54.9873H54.4883C53.4363 54.9939 52.5906 55.8295 52.585 56.8812C52.5792 57.9329 53.4384 58.7901 54.49 58.7959H54.5007C55.5476 58.7959 56.3992 57.9501 56.4048 56.902C56.4103 55.8503 55.5625 54.9931 54.5109 54.9873Z" fill="#CDC8CD"/>
    <path d="M75.3248 58.7852C75.339 58.7868 75.3537 58.7865 75.3679 58.7878C75.4147 58.7916 75.4611 58.7954 75.5089 58.7956H75.5195H75.5221C75.5236 58.7956 75.5249 58.7954 75.5264 58.7954C75.5896 58.7951 75.6521 58.7921 75.7138 58.786C76.6756 58.6898 77.4264 57.8783 77.4264 56.8913C77.4264 55.8582 76.6029 55.019 75.5769 54.9898C75.5612 54.9893 75.5457 54.9873 75.5297 54.9873H75.5238C75.5233 54.9873 75.5226 54.9873 75.5221 54.9873H75.5071H75.499C75.4982 54.9873 75.4972 54.9873 75.4964 54.9873C74.4498 54.9873 73.6094 55.8331 73.6035 56.8812C73.5982 57.8704 74.3587 58.6872 75.3248 58.7852Z" fill="#CDC8CD"/>
    <path d="M47.8087 9.02249C48.1805 9.39447 48.668 9.58033 49.1552 9.58033C49.6425 9.58033 50.13 9.39447 50.5017 9.02249L52.0411 7.48306L53.5805 9.02249C53.9523 9.39421 54.4398 9.58033 54.927 9.58033C55.4143 9.58033 55.9018 9.39447 56.2735 9.02249C57.0172 8.2788 57.0172 7.073 56.2735 6.32957L54.734 4.79013L56.2735 3.2507C57.0172 2.50701 57.0172 1.30121 56.2735 0.557769C55.53 -0.185923 54.3242 -0.185923 53.5805 0.557769L52.0411 2.0972L50.5017 0.557769C49.758 -0.185923 48.5522 -0.185923 47.8087 0.557769C47.0651 1.30146 47.0651 2.50726 47.8087 3.2507L49.3482 4.79013L47.8087 6.32957C47.0651 7.07326 47.0651 8.27906 47.8087 9.02249Z" fill="#CDC8CD"/>
    <path d="M34.2409 28.8844C39.0354 28.8844 42.9359 24.9839 42.9359 20.1892C42.9359 15.3946 39.0354 11.4941 34.2409 11.4941C29.4464 11.4941 25.5459 15.3946 25.5459 20.1892C25.5459 24.9839 29.4467 28.8844 34.2409 28.8844ZM34.2409 15.303C36.9354 15.303 39.1273 17.495 39.1273 20.1894C39.1273 22.8839 36.9354 25.0761 34.2409 25.0761C31.5465 25.0761 29.3545 22.8841 29.3545 20.1894C29.3545 17.495 31.5467 15.303 34.2409 15.303Z" fill="#CDC8CD"/>
    <path d="M90.8791 27.709C91.2508 28.0807 91.7383 28.2669 92.2255 28.2669C92.7128 28.2669 93.2003 28.081 93.572 27.709L95.1114 26.1696L96.6509 27.709C97.0226 28.0807 97.5101 28.2669 97.9973 28.2669C98.4846 28.2669 98.9721 28.081 99.3438 27.709C100.087 26.9653 100.087 25.7595 99.3438 25.0161L97.8044 23.4767L99.3438 21.9372C100.087 21.1935 100.087 19.9877 99.3438 19.2443C98.6001 18.5006 97.3943 18.5006 96.6509 19.2443L95.1114 20.7837L93.572 19.2443C92.8283 18.5006 91.6225 18.5006 90.8791 19.2443C90.1354 19.988 90.1354 21.1938 90.8791 21.9372L92.4185 23.4767L90.8791 25.0161C90.1354 25.7598 90.1354 26.9656 90.8791 27.709Z" fill="#CDC8CD"/>
    <path d="M64.8948 27.4215H64.9007C65.9495 27.4215 66.8016 26.5727 66.8049 25.5228L66.8217 19.8523C66.8248 18.8006 65.9749 17.9454 64.923 17.9424C64.921 17.9424 64.9192 17.9424 64.9172 17.9424C63.8683 17.9424 63.0162 18.7912 63.0129 19.8411L62.9961 25.5116C62.9931 26.563 63.8431 27.4182 64.8948 27.4215Z" fill="#CDC8CD"/>
    <path d="M52.5197 21.3813C51.6176 21.9216 51.3243 23.0911 51.8646 23.9935L54.8109 28.9127C55.1679 29.5086 55.7989 29.8387 56.4464 29.8387C56.7792 29.8387 57.1167 29.7514 57.4231 29.5678C58.3253 29.0275 58.6185 27.858 58.0782 26.9556L55.1319 22.0364C54.5913 21.1343 53.4218 20.8408 52.5197 21.3813Z" fill="#CDC8CD"/>
    <path d="M72.3549 29.6394C72.6637 29.8268 73.0047 29.9159 73.3411 29.9159C73.9847 29.9159 74.6126 29.5896 74.9709 28.9996L77.9467 24.0966C78.4923 23.1976 78.2059 22.0263 77.3068 21.4806C76.4075 20.9352 75.2365 21.2214 74.6908 22.1205L71.7151 27.0234C71.1694 27.9225 71.4561 29.0938 72.3549 29.6394Z" fill="#CDC8CD"/>
    <path d="M82.3823 17.0096C86.4067 17.0096 89.6806 13.7355 89.6806 9.71137C89.6806 5.68721 86.4067 2.41309 82.3823 2.41309C78.3578 2.41309 75.084 5.68721 75.084 9.71137C75.084 13.7355 78.3578 17.0096 82.3823 17.0096ZM82.3823 6.22168C84.3066 6.22168 85.872 7.78727 85.872 9.71137C85.872 11.6355 84.3064 13.2011 82.3823 13.2011C80.4582 13.2011 78.8926 11.6355 78.8926 9.71137C78.8926 7.78727 80.4579 6.22168 82.3823 6.22168Z" fill="#CDC8CD"/>
  </g>
  <defs>
    ...
    return {
      ...
      series: [44, 55, 13, 43, 22, 44, 55, 13, 43],
          chartOptions: {
            ...
            labels: ['Team A', 'Team B', 'Team C', 'Team D', 'Team E', 'Team C', 'Team D', 'Team E'],
            responsive: [{
              breakpoint: 480,
              options: {
                chart: {
